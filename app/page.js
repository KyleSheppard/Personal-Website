...
export default function Home() {
  return (
    <main>
      ...
      <p>
        I will complete my Bachelor&apos;s Degree in Computer Science in June of 2027. At that point, I would like to find an entry-level job in the Rogue Valley doing software research and development. Until then, I have a lot more to learn, and I am hopeful that next summer I can get an internship in a field related to what I want to pursue.
      </p>
